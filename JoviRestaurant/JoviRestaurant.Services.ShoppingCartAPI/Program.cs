using AutoMapper;
using JoviRestaurant.Services.ShoppingCartAPI;
...
builder.Services.AddAuthorization(options =>
{
    options.AddPolicy("ApiScope", policy =>
    {
        ...
        policy.RequireClaim("scope", "jovirestaurant");
    });
});
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "JoviRestaurant.Services.ShoppingCartAPI", Version = "v1" });
    c.EnableAnnotations();
